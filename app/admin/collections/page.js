    ...
    <div className="min-h-screen bg-[#FAF9F6]">
      <header className="bg-white border-b border-[#d1d1d1] px-8 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <nav className="flex items-center gap-6">
          <a href="/admin/dashboard" className="text-xs uppercase tracking-widest text-mid-gray hover:text-charcoal transition-colors">Photos</a>
          <a href="/admin/collections" className="text-xs uppercase tracking-widest text-orange">Collections</a>
      ...
      <main className="max-w-6xl mx-auto px-8 py-10">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-3">
            {collections.map((c) => (
              <div key={c.id} className="bg-white border border-[#d1d1d1] rounded flex items-center gap-4 p-4">
                {/* Cover thumbnail */}
