    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          photosInterest: fields.photosInterest.trim(),
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
      ...
      <div>
        ...
        <input
          type="text"
          value={fields.photosInterest}
          onChange={(e) => set('photosInterest', e.target.value)}
          placeholder="Title(s) of the photo(s) you're interested in"
          className={inputClass}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="How do you plan to use the image?"
          className={inputClass}
        />
      </div>
